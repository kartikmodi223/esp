...
app.get('/:page',(req,res)=>{
  ...
  let offset=(page - 1)*limit;
      ...
      con1.query(`select * from student_express  LIMIT ${offset}, ${limit} `,(err,result)=>{
          if (err) throw err;
          // res.render('table',{data:result})
  
   con1.query(`select count(*) as count  from student_express`,(err,outcome)=>{
          if (err) throw err;
     ...
     for(let i=1; i<=totalpages;i++){
      pages.push(i);
          ...
          res.render('pagination',{data:result,page:page,pages:pages});
      });
    });
  });
